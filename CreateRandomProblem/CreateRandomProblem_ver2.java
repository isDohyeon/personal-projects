...
public class CreateRandomProblem_ver2
{
    public static void main(String[] args)
    {
        ...
        for (int i = problem.length - 1; i >= 0; i--)
        {
            ...
            problem[newNumber] = tempProblem;
            //섞인 문제에 맞게 정답 매핑
            String tempCorrectAnswer = correctAnswer[i];
            correctAnswer[i] = correctAnswer[newNumber];
            correctAnswer[newNumber] = tempCorrectAnswer;
        }
        //문제 출력
        System.out.println("안녕하세요 도현이가 만든 모의고사 프로그램(ver.2)에 오신 걸 환영합니다!");
